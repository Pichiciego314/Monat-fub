...
#
    ...
    def simple_parking(self):
      ...
      #  rospy.sleep(1.0)
        ...
        self.network.load_weights('/home/alvarado/catkin_emiliano/src/assigment_publisher_subscriber/src/net1.h5')
	...
	test_images = cv2.resize(test_images, (56, 56), interpolation = cv2.INTER_AREA) #esto es lo que se cambia para el tamamio de la imagen
