...
base_dir = '/home/catkin_emiliano/Images'
...
if load_my_database:
    ...
    # Aqui las del cuatro
    no_de_imagenes = 111 # Modificable
    ...
    # Aqui las del cero
    no_de_imagenes = 335 # Modificable
    no_inicial = 1 # Modificable
    my_train_images_ = np.zeros((no_de_imagenes, 28, 28))
    my_train_labels_ = np.zeros((no_de_imagenes))
    for i in range(0, no_de_imagenes):
...
network.save_weights('/home/alvarado/catkin_emiliano/src/assigment_publisher_subscriber/src/last.h5')
